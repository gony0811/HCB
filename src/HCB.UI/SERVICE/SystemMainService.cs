...
namespace HCB.UI
{
    ...
    public class SystemMainService : IMainService
    {
        ...
        public SystemMainService(ILogger logger, DeviceManager deviceManager, ISequenceHelper sequenceHelper, DataOptions dataOptions, OperationService operationService, AlarmService alarmService, SequenceServiceVM sequenceServiceVM)
        {
